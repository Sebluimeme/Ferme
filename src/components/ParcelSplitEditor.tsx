...
export default function ParcelSplitEditor({ parcelle, onClose, onConfirm, saving }: Props) {
  ...
  if (!ring.length) {
    return (
      <div className="text-center py-8 text-stone-500">
        ...
        <button onClick={onClose} className="mt-4 px-4 py-2 bg-stone-100 rounded-lg text-sm cursor-pointer">
          Fermer
        </button>
      </div>
    );
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div style={{ height: "520px" }} className="relative rounded-xl overflow-hidden border border-stone-200">
        <button
      ...
      <div className="flex items-center gap-2 flex-wrap">
        <button
          onClick={handleReset}
          disabled={phase === "idle"}
          className="px-4 py-2 text-sm font-medium bg-stone-100 text-stone-700 border border-stone-200 rounded-lg hover:bg-stone-200 cursor-pointer disabled:opacity-40"
        >
          Réinitialiser
        </button>
        {canUndo && (
          <button
            onClick={handleUndo}
            className="px-4 py-2 text-sm font-medium bg-stone-100 text-stone-700 border border-stone-200 rounded-lg hover:bg-stone-200 cursor-pointer"
          >
            ↩ Annuler dernier
          </button>
        )}
        ...
        <button
          ...
          className="px-5 py-2 text-sm font-semibold text-white rounded-lg bg-brand-600 cursor-pointer disabled:opacity-40"
        >
          ✂️ Diviser en 2
        </button>
      </div>
      ...
      {showNames && (
        <div className="bg-stone-50 border border-stone-200 rounded-xl p-4 flex flex-col gap-3">
          <p className="text-sm font-semibold text-stone-700 m-0">Nommez les 2 nouvelles parcelles :</p>
          ...
          <div className="flex justify-end gap-3">
            <button
              ...
              className="px-4 py-2 text-sm bg-stone-100 text-stone-700 border border-stone-300 rounded-lg hover:bg-stone-200 cursor-pointer"
            >
              Retour
            </button>
            <button
              ...
              className="px-5 py-2 text-sm font-semibold text-white rounded-lg bg-brand-600 cursor-pointer disabled:opacity-50"
            >

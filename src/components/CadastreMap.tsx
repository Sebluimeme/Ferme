...
export default function CadastreMap({ onSelect, onClose }: CadastreMapProps) {
  ...
  return (
    <div className="flex flex-col h-full">
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg px-4 py-3 mb-3">
          <div className="flex items-start justify-between gap-3">
            ...
            <button
              ...
              className="shrink-0 px-4 py-2 text-sm font-semibold text-white rounded-lg bg-brand-600 hover:bg-brand-700 transition-colors cursor-pointer shadow-sm"
            >
      ...
      {/* Carte */}
      <div className="relative flex-1 rounded-xl overflow-hidden border border-stone-200" style={{ minHeight: "420px" }}>
        <button

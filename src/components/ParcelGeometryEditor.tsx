...
export default function ParcelGeometryEditor({
  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      {/* Carte */}
      <div className="relative rounded-xl overflow-hidden border border-gray-200" style={{ height: "420px" }}>
        <button
          type="button"
          onClick={() => setSatellite((v) => !v)}
          className="absolute top-2 left-2 z-[1000] px-2 py-1 text-xs font-semibold bg-white border border-gray-300 rounded shadow-sm hover:bg-gray-50 transition-colors"
        >
